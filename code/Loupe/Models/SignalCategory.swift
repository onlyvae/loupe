...
enum SignalCategory: String, Codable, Sendable, CaseIterable, Identifiable, Hashable {
    ...
    var title: String {
        ...
        case .securityDetection: return String(localized: "Security Detection", comment: "Category title shown in the home list, navigation bar, and as a heading on the per-category screen.")
    ...
    var subtitle: String {
        ...
        case .securityDetection: return String(localized: "Jailbreak and hook indicators", comment: "Category subtitle shown beneath the title in the home list. Brief description of what the category covers.")
    ...
    var symbolName: String {
        ...
        case .securityDetection: return "lock.open.trianglebadge.exclamationmark"
